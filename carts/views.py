...
def cart_change(request):
    ...
    response_data = {'message': "hanged quantity", "cart_items_html": cart_items_html, "quantity_deleted": quantity}
...
def cart_remove(request):
    ...
    response_data = {'message': "Tovar delete", "cart_items_html": cart_items_html, "quantity_deleted": quantity}
